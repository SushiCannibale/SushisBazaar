...
@EventBusSubscriber(modid = SushisBazaar.MODID, bus = EventBusSubscriber.Bus.MOD)
public class Config
{
	...
	private static boolean validateItemName(final Object obj)
	{
		return obj instanceof String itemName &&
			   BuiltInRegistries.ITEM.containsKey(ResourceLocation.parse(
					   itemName));
	}
	...
	static void onLoad(final ModConfigEvent event)
	{
		...
		items = ITEM_STRINGS
				.get()
				.stream()
				.map(itemName -> BuiltInRegistries.ITEM.getValue(
