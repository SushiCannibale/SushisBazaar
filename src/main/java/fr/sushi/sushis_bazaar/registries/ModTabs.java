...
public class ModTabs
{
	...
	public static final DeferredHolder<CreativeModeTab, CreativeModeTab>
			...
			() -> CreativeModeTab.builder()
					.title(Component.translatable("itemGroup.sushis_bazaar"))
					.withTabsBefore(CreativeModeTabs.COMBAT)
					.icon(() -> ModItems.SHAKY_SHAKE.get().getDefaultInstance())
					.displayItems((parameters, output) ->
					{
						output.accept(ModItems.SHAKY_SHAKE.get());
						output.accept(ModItems.THROWABLE_BRICK.get());
					}).build());
}
